if(location.hostname.match()){
    $(document).ready(function(){
        ...
        function changeColor(skinName){
            ...
            $("#cssfile").attr('href','/template/ec_MG/css/'+skinName+'.css');
        ...
        $('#ssdi').click(function(){
            var jxapi = $('#jk').val();
            var jxurl = $('#url').val();
            var official = jxurl.search(/iqiyi.com|v.qq.com|youku.com|mgtv.com|pptv.com|1905.com/gi);
            if(official == -1){
        ...
        $("#ec-xlqh button").click(function(){
            ...
            var official = jburl.search(/iqiyi.com|v.qq.com|youku.com|mgtv.com|pptv.com|1905.com/gi);
            if(official == -1){
