...
jQuery.showfloatdiv = function(ox) {
    ...
    if (oxdefaults.wantclose == 1) {
        var floatdiv = $('<div class="flavr-container modal" id="qirebox_overlay"><div class="flavr-overlay"></div><div class="flavr-fixer"><div class="flavr-outer"><div class="flavr-content"><div class="flavr-message"><i class="fa fa-bell-o"></i>' + oxdefaults.txt + '</div></div></div></div></div>');
