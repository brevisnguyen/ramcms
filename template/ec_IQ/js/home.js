...
var MAC={
    ...
    'Pop':{
        ...
        'Msg':function($w,$h,$msg,$timeout){
            ...
            $('body').append('<div class="flavr-container modal mac_pop_msg"><div class="flavr-overlay"></div><div class="flavr-fixer"><div class="flavr-outer"><div class="flavr-content"><div class="flavr-message pop-msg"></div></div></div></div></div>');
        ...
        'Show':function($w,$h,$title,$url,$callback) {
            ...
            $('body').append('<div class="mac_pop_bg"></div><div class="mac_pop box fadeInUp animated"><div class="pop_top"><h2></h2><span class="pop_close fa fa-remove"></span></div><div class="line"></div><div class="pop_content"></div></div>');
