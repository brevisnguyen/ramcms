...
var MAC={
    ...
    'Copy': function(s){
        ...
        MAC.Pop.Msg(100,20,'sao chép thành công',1000);
    },
    'Home': function(o,u){
        try{
            ...
            if(window.netscape){
                ...
                catch(e){ MAC.Pop.Msg(150,40,'thao tác lần này bị trình duyệt từ chối! Mời cài đặt bằng tay',1000); }
    ...
    'Fav': function(u,s){
        try{ window.external.addFavorite(u, s);}
            ...
            try{window.sidebar.addPanel(s, u, "");}catch (e){ MAC.Pop.Msg(150,40,'thêm vào phần lưu sai xót, Mời sử dụng tổ phím Ctrl +D tiến hành thêm ',1000); }
        }
    },
    'Open': function(u,w,h){
    ...
    'Verify': {
        ...
        'Show':function(){
            return '<img class="mac_verify_img" src="'+ maccms.path +'/index.php/verify/index.html?"  title="nhìn không rõ? đổi trang khác！">';
        }
    },
    'PageGo':{
        'Init':function() {
    ...
    'Score': {
        'Init':function(){
            ...
            MAC.Ajax(maccms.path+'/index.php/ajax/score?mid='+ $('.mac_score').attr('data-mid') +'&id=' +$('.mac_score').attr('data-id'),'post','json','',function(r){
                ...
                $(".mac_score").html('Tải đánh giá điểm thất bại');
            });
            ...
            $('.mac_star').raty({
                ...
                click: function(score, evt) {
                    ...
                    MAC.Ajax(maccms.path+'/index.php/ajax/score?mid='+$('.mac_star').attr('data-mid')+'&id='+$('.mac_star').attr('data-id')+'&score='+(score*2),'get','json','',function(r){
                        ...
                        $('.star_box').attr('title', 'Mạng bất thường！');
                    });
    ...
    'Gbook':{
        ...
        'Show':function($page){
            MAC.Ajax(maccms.path+'/index.php/gbook/index?page='+$page,'post','json','',function(r){
                ...
                $(".mac_gbook_box").html('Tải lời bình thất bại, Mời thử lại...');
            });
        },
        'Submit':function(){
            if($(".gbook_content").val() == ''){
                MAC.Pop.Msg(100,20,'Mời nhập lời bình của bạn言!',1000);
                return false;
            }
        ...
        'Report':function(name,id){
            MAC.Pop.Show(400,300,'Số liệu báo sai',maccms.path+'/index.php/gbook/report.html?id='+id+'&name='+ encodeURIComponent(name),function(r){
    ...
    'History': {
        ...
        'Init':function(){
            ...
            if(jsondata.length > 0){
                ...
                html +='<dd class="hide">Tạm thời không có lịch sử trình duyệt录</dd>';
            }
            html += '</dl>';
        ...
        'Clear': function(){
            ...
            $('.mac_history_box').html('<li class="hx_clear">Đã xóa toàn bộ lịch sử xem。</li>');
        },
    },
    'Ulog':{
        'Init':function(){
    ...
    'User':{
        ...
        'Init':function(){
            ...
            if(MAC.Cookie.Get('user_id') !=undefined && MAC.Cookie.Get('user_id')!=''){
                ...
                if($('.mac_user').length >0) {
                    ...
                    html += '<ul class="logged"><li><a target="_blank" href="' + url + '">Trung tâm người dùng</a></li><li class="logout"><a class="logoutbt" href="javascript:;" onclick="MAC.User.Logout();" target="_self"><i class="user-logout"></i>thoát ra</a></li></ul>'
        ...
        'Login':function(){
            ...
            MAC.Pop.Show(400,380,'Người dùng đăng nhập',maccms.path+'/index.php/user/'+ac,function(r){
        ...
        'BuyPopedom':function(o){
            var $that = $(o);
            if($that.attr("data-id")){
                if (confirm('Bạn đã xác nhận quyền thăm hỏi mua số liệu này chưa？')) {
    ...
    'Pop':{
        ...
        'Show':function($w,$h,$title,$url,$callback) {
            ...
            MAC.Ajax($url,'post','json','',function(r){
                ...
                $(".pop_content").html('Tải thất bại, Mời thử lại...');
            });
    ...
    'Comment':{
        ...
        'Show':function($page){
            if($(".mac_comment").length>0){
                MAC.Ajax(maccms.path + '/index.php/comment/ajax.html?rid='+$('.mac_comment').attr('data-id')+'&mid='+ $('.mac_comment').attr('data-mid') +'&page='+$page,'get','json','',function(r){
                    ...
                    $(".mac_comment").html('<a href="javascript:void(0)" onclick="MAC.Comment.Show('+$page+')">Tải bình luận thất bại, nhấn vào làm mới...</a>');
                });
            }
        },
        'Reply':function($o){
        ...
        'Submit':function($o){
            ...
            if($(form).find(".comment_content").val() == ''){
                MAC.Pop.Msg(100,20,'Mời nhập bình luận của bạn！',1000);
                return false;
            }
            if($('.mac_comment').attr('data-mid') == ''){
                MAC.Pop.Msg(100,20,'mô đun mid sai！',1000);
                return false;
            }
            if($('.mac_comment').attr('data-id') == ''){
                MAC.Pop.Msg(100,20,'ID liên quan sai！',1000);
                return false;
            }
