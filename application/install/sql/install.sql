...
CREATE TABLE IF NOT EXISTS `mac_actor` (
  ...
  `actor_name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `actor_en` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `actor_alias` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `actor_status` tinyint unsigned NOT NULL DEFAULT '0',
  `actor_lock` tinyint unsigned NOT NULL DEFAULT '0',
  `actor_letter` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `actor_sex` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `actor_color` varchar(6) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `actor_pic` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `actor_blurb` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `actor_remarks` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `actor_area` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `actor_height` varchar(10) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `actor_weight` varchar(10) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `actor_birthday` varchar(10) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `actor_birtharea` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `actor_blood` varchar(10) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `actor_starsign` varchar(10) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `actor_school` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `actor_works` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `actor_tag` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `actor_class` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  ...
  `actor_tpl` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `actor_jumpurl` varchar(150) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `actor_content` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mac_admin` (
  ...
  `admin_name` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `admin_pwd` char(32) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `admin_random` char(32) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `admin_status` tinyint unsigned NOT NULL DEFAULT '1',
  `admin_auth` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
...
-- 正在导出表  ramcms.mac_admin 的数据：~1 rows (大约)
...
CREATE TABLE IF NOT EXISTS `mac_annex` (
  ...
  `annex_file` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `annex_size` int unsigned NOT NULL DEFAULT '0',
  `annex_type` varchar(8) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `mac_art` (
  ...
  `art_name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `art_sub` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `art_en` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `art_status` tinyint unsigned NOT NULL DEFAULT '0',
  `art_letter` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `art_color` varchar(6) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `art_from` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `art_author` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `art_tag` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `art_class` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `art_pic` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `art_pic_thumb` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `art_pic_slide` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `art_pic_screenshot` mediumtext COLLATE utf8mb4_general_ci,
  `art_blurb` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `art_remarks` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `art_jumpurl` varchar(150) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `art_tpl` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  ...
  `art_rel_art` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `art_rel_vod` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `art_pwd` varchar(10) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `art_pwd_url` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `art_title` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `art_note` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `art_content` longtext COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`art_id`),
  KEY `type_id` (`type_id`) USING BTREE,
  KEY `type_id_1` (`type_id_1`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `mac_card` (
  ...
  `card_no` varchar(16) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `card_pwd` varchar(8) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `mac_cash` (
  ...
  `cash_bank_name` varchar(60) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `cash_bank_no` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `cash_payee_name` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `mac_cj_content` (
  ...
  `url` char(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mac_cj_history` (
  `md5` char(32) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`md5`),
  KEY `md5` (`md5`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `mac_cj_node` (
  ...
  `sourcecharset` varchar(8) COLLATE utf8mb4_general_ci NOT NULL,
  `sourcetype` tinyint unsigned NOT NULL DEFAULT '0',
  `urlpage` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  `pagesize_start` tinyint unsigned NOT NULL DEFAULT '0',
  `pagesize_end` mediumint unsigned NOT NULL DEFAULT '0',
  `page_base` char(255) COLLATE utf8mb4_general_ci NOT NULL,
  `par_num` tinyint unsigned NOT NULL DEFAULT '1',
  `url_contain` char(100) COLLATE utf8mb4_general_ci NOT NULL,
  `url_except` char(100) COLLATE utf8mb4_general_ci NOT NULL,
  `url_start` char(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `url_end` char(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `title_rule` char(100) COLLATE utf8mb4_general_ci NOT NULL,
  `title_html_rule` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  `type_rule` char(100) COLLATE utf8mb4_general_ci NOT NULL,
  `type_html_rule` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  `content_rule` char(100) COLLATE utf8mb4_general_ci NOT NULL,
  `content_html_rule` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  `content_page_start` char(100) COLLATE utf8mb4_general_ci NOT NULL,
  `content_page_end` char(100) COLLATE utf8mb4_general_ci NOT NULL,
  `content_page_rule` tinyint unsigned NOT NULL DEFAULT '0',
  `content_page` tinyint unsigned NOT NULL DEFAULT '0',
  `content_nextpage` char(100) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `customize_config` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  `program_config` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mac_collect` (
  ...
  `collect_name` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `collect_url` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `collect_type` tinyint unsigned NOT NULL DEFAULT '1',
  `collect_mid` tinyint unsigned NOT NULL DEFAULT '1',
  `collect_appid` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `collect_appkey` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `collect_param` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `collect_filter` tinyint unsigned NOT NULL DEFAULT '0',
  `collect_filter_from` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
...
-- 正在导出表  ramcms.mac_collect 的数据：~1 rows (大约)
...
CREATE TABLE IF NOT EXISTS `mac_comment` (
  ...
  `comment_name` varchar(60) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `comment_ip` int unsigned NOT NULL DEFAULT '0',
  `comment_time` int unsigned NOT NULL DEFAULT '0',
  `comment_content` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `mac_gbook` (
  ...
  `gbook_name` varchar(60) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  ...
  `gbook_content` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `gbook_reply` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
...
-- 正在导出表  ramcms.mac_gbook 的数据：~2 rows (大约)
...
CREATE TABLE IF NOT EXISTS `mac_group` (
  ...
  `group_name` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `group_status` tinyint unsigned NOT NULL DEFAULT '1',
  `group_type` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  `group_popedom` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mac_link` (
  ...
  `link_name` varchar(60) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  ...
  `link_logo` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`link_id`),
...
CREATE TABLE IF NOT EXISTS `mac_msg` (
  ...
  `msg_to` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `msg_code` varchar(10) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `msg_content` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `mac_order` (
  ...
  `order_code` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  ...
  `order_pay_type` varchar(10) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `order_pay_time` int unsigned NOT NULL DEFAULT '0',
  `order_remarks` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `mac_plog` (
  ...
  `plog_remarks` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`plog_id`),
  KEY `user_id` (`user_id`),
...
CREATE TABLE IF NOT EXISTS `mac_role` (
  ...
  `role_name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `role_en` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `role_status` tinyint unsigned NOT NULL DEFAULT '0',
  `role_lock` tinyint unsigned NOT NULL DEFAULT '0',
  `role_letter` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `role_color` varchar(6) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `role_actor` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `role_remarks` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `role_pic` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  ...
  `role_tpl` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `role_jumpurl` varchar(150) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `role_content` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`role_id`),
...
CREATE TABLE IF NOT EXISTS `mac_tmpart` (
  ...
  `name1` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `mac_topic` (
  ...
  `topic_name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `topic_en` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `topic_sub` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `topic_status` tinyint unsigned NOT NULL DEFAULT '1',
  `topic_sort` smallint unsigned NOT NULL DEFAULT '0',
  `topic_letter` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `topic_color` varchar(6) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `topic_tpl` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `topic_type` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `topic_pic` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `topic_pic_thumb` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `topic_pic_slide` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `topic_key` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `topic_des` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `topic_title` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `topic_blurb` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `topic_remarks` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  ...
  `topic_tag` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `topic_rel_vod` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  `topic_rel_art` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  `topic_content` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  `topic_extend` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mac_type` (
  ...
  `type_name` varchar(60) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `type_en` varchar(60) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  ...
  `type_tpl` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `type_tpl_list` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `type_tpl_detail` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `type_tpl_play` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `type_tpl_down` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `type_key` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `type_des` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `type_title` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `type_union` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `type_extend` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  `type_logo` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `type_pic` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `type_jumpurl` varchar(150) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`type_id`),
...
CREATE TABLE IF NOT EXISTS `mac_user` (
  ...
  `group_id` smallint unsigned NOT NULL DEFAULT '0',
  `user_name` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `user_pwd` varchar(32) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `user_nick_name` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `user_qq` varchar(16) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `user_email` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `user_phone` varchar(16) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `user_status` tinyint unsigned NOT NULL DEFAULT '0',
  `user_portrait` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `user_portrait_thumb` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `user_openid_qq` varchar(40) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `user_openid_weixin` varchar(40) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `user_question` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `user_answer` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  ...
  `user_random` varchar(32) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `mac_visit` (
  ...
  `visit_ly` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `mac_vod` (
  ...
  `type_id_1` smallint unsigned NOT NULL DEFAULT '0',
  `group_id` smallint unsigned NOT NULL DEFAULT '0',
  `vod_name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_sub` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  ...
  `vod_letter` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_color` varchar(6) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_tag` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_class` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_pic` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_pic_thumb` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_pic_slide` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_pic_screenshot` mediumtext COLLATE utf8mb4_general_ci,
  `vod_actor` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_director` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_writer` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_behind` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_blurb` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_remarks` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_pubdate` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_total` mediumint unsigned NOT NULL DEFAULT '0',
  `vod_serial` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0',
  `vod_tv` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_weekday` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_area` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_lang` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `vod_year` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_version` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_state` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_author` varchar(60) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_jumpurl` varchar(150) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_tpl` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_tpl_play` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_tpl_down` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  ...
  `vod_duration` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `vod_reurl` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_rel_vod` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_rel_art` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_pwd` varchar(10) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_pwd_url` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_pwd_play` varchar(10) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_pwd_play_url` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_pwd_down` varchar(10) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_pwd_down_url` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_content` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `vod_play_from` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_play_server` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_play_note` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_play_url` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `vod_down_from` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_down_server` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_down_note` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `vod_down_url` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `vod_plot` tinyint unsigned NOT NULL DEFAULT '0',
  `vod_plot_name` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `vod_plot_detail` longtext COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`vod_id`),
  KEY `type_id` (`type_id`) USING BTREE,
  KEY `type_id_1` (`type_id_1`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `mac_vod_search` (
  ...
  `search_word` varchar(128) COLLATE utf8mb4_general_ci NOT NULL COMMENT '搜索关键词',
...
CREATE TABLE IF NOT EXISTS `mac_website` (
  ...
  `type_id` smallint unsigned NOT NULL DEFAULT '0',
  `type_id_1` smallint unsigned NOT NULL DEFAULT '0',
  `website_name` varchar(60) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `website_sub` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `website_en` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `website_status` tinyint unsigned NOT NULL DEFAULT '0',
  `website_letter` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `website_color` varchar(6) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `website_lock` tinyint unsigned NOT NULL DEFAULT '0',
  `website_sort` int NOT NULL DEFAULT '0',
  `website_jumpurl` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `website_pic` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `website_pic_screenshot` mediumtext COLLATE utf8mb4_general_ci,
  `website_logo` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `website_area` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `website_lang` varchar(10) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  ...
  `website_tag` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `website_class` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `website_remarks` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `website_tpl` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `website_blurb` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `website_content` longtext COLLATE utf8mb4_general_ci NOT NULL,
