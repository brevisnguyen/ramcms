...
CREATE TABLE `mac_actor` (
  ...
  `actor_content` text NULL DEFAULT NULL,
...
CREATE TABLE `mac_vod` (
  ...
  `vod_tag` text NULL DEFAULT NULL ,
  ...
  `vod_plot_name` mediumtext NULL DEFAULT NULL ,
  `vod_plot_detail` mediumtext NULL DEFAULT NULL ,
  PRIMARY KEY (`vod_id`),
  KEY `type_id` (`type_id`) USING BTREE,
  KEY `type_id_1` (`type_id_1`) USING BTREE,
